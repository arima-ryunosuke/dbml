...
trait SubSelectTrait
{
     ...
     */
    public function subselectArray($tableDescriptor, $where = [], $orderBy = [], $limit = [], $groupBy = [], $having = [])
    {
     ...
     * @inheritdoc Database::subselect()
     */
    public function subselectAssoc($tableDescriptor, $where = [], $orderBy = [], $limit = [], $groupBy = [], $having = [])
    {
     ...
     * @inheritdoc Database::subselect()
     */
    public function subselectLists($tableDescriptor, $where = [], $orderBy = [], $limit = [], $groupBy = [], $having = [])
    {
     ...
     * @inheritdoc Database::subselect()
     */
    public function subselectPairs($tableDescriptor, $where = [], $orderBy = [], $limit = [], $groupBy = [], $having = [])
    {
     ...
     * @inheritdoc Database::subselect()
     */
    public function subselectTuple($tableDescriptor, $where = [], $orderBy = [], $limit = [], $groupBy = [], $having = [])
    {
     ...
     * @inheritdoc Database::subselect()
     */
    public function subselectValue($tableDescriptor, $where = [], $orderBy = [], $limit = [], $groupBy = [], $having = [])
    {
