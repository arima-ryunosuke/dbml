...
class v_blogTableGateway extends \ryunosuke\dbml\Gateway\TableGateway
{
    ...
    /**
     * @return array<v_blogEntity>|array<array{article_id: int, title: string, comment_id: int, comment: string}>
     */
    public function neighbor(array $predicates = [], int $limit = 1):array { }

    /**
     * @param array<v_blogEntity>|array<array{article_id: int, title: string, comment_id: int, comment: string}> $data
     */
    public function insertArray($data, ...$opt) { }
    ...
    /**
     * @param array<v_blogEntity>|array<array{article_id: int, title: string, comment_id: int, comment: string}> $data
     * @param array{article_id: int, title: string, comment_id: int, comment: string} $where
     */
    public function updateArray($data, $where = [], ...$opt) { }
    ...
    /**
     * @param array<array{article_id: int, title: string, comment_id: int, comment: string}> $where
     */
    public function deleteArray($where = [], ...$opt) { }
    ...
    /**
     * @param array<v_blogEntity>|array<array{article_id: int, title: string, comment_id: int, comment: string}> $insertData
     * @param v_blogEntity|array{article_id: int, title: string, comment_id: int, comment: string} $updateData
     */
    public function modifyArray($insertData, $updateData = [], $uniquekey = "PRIMARY", ...$opt) { }
    ...
    /**
     * @param array<v_blogEntity>|array<array{article_id: int, title: string, comment_id: int, comment: string}> $dataarray
     * @param array{article_id: int, title: string, comment_id: int, comment: string} $where
     */
    public function changeArray($dataarray, $where, $uniquekey = "PRIMARY", $returning = [], ...$opt) { }
    ...
    /**
     * @param v_blogEntity|array{article_id: int, title: string, comment_id: int, comment: string} $data
     */
    public function save($data, ...$opt) { }
    ...
    /**
     * @param array{article_id: int, title: string, comment_id: int, comment: string} $where
     * @param array{article_id: int, title: string, comment_id: int, comment: string} $invalid_columns
     */
    public function invalid($where = [], ?array $invalid_columns = null, ...$opt) { }
    ...
    /**
     * @param v_blogEntity|array{article_id: int, title: string, comment_id: int, comment: string} $insertData
     * @param v_blogEntity|array{article_id: int, title: string, comment_id: int, comment: string} $updateData
     */
    public function upsert($insertData, $updateData = [], ...$opt) { }
    ...
    /**
     * @return iterable<v_blogEntity|array{article_id: int, title: string, comment_id: int, comment: string}>
     */
    public function yieldArray($tableDescriptor = [], $where = [], $orderBy = [], $limit = [], $groupBy = [], $having = []) { }
